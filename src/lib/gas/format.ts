const nfMcm = new Intl.NumberFormat("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 });
...
const nfTemp = new Intl.NumberFormat("en-US", { minimumFractionDigits: 1, maximumFractionDigits: 1 });
...
export const fmtPrice = (v: number | null | undefined, ccy: string) =>
  v == null || Number.isNaN(v)
    ? "–"
    : `${v < 0.01 ? v.toExponential(2) : v.toFixed(5)} ${ccy}`;
